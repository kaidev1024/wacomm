...
import { EditIcon, P, SaveCancelButtons, StaticColumn, StaticRow } from 'src';
...
function TextUpdater({
  ...
  return isEditing ? (
    <StaticColumn className="TextUpdaterEditing w-full gap-2">
      <TextareaAutosize
    ...
    <StaticRow
      className={twcn('TextUpdaterNonEditing w-full gap-2 items-start', classNameNonEditing)}
    >
