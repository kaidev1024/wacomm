...
describe('Button', () => {
  ...
  test('combines disabled and highlighted states', () => {
    render(<Button label="Disabled Highlighted" onClick={mockOnClick} disabled={true} isHighlighted={true} />);
  ...
  test('combines loading and highlighted states', () => {
    render(<Button label="Loading Highlighted" onClick={mockOnClick} isLoading={true} isHighlighted={true} />);
